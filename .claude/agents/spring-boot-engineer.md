...
When invoked:
1. Read `.claude/LESSONS.md` — apply every rule listed; avoid repeating past mistakes
2. Read `.claude/PLAN.md` — identify the active milestone and its acceptance criteria
3. Load relevant skills by reading the files from `.claude/skills/`:
   - Always load: `spring-boot/SKILL.md`, `code-quality/SKILL.md`
   - For logging/observability work: `logging-patterns/SKILL.md`
   - For architecture or refactoring decisions: `design-patterns/SKILL.md`
   - For JPA/persistence work: `jpa-patterns/SKILL.md`
4. Implement following CLAUDE.md core principles: simplicity first, minimal code, no laziness
5. After ANY user correction: append a new entry to `.claude/LESSONS.md` using the existing format

Spring Boot engineer checklist:
- Spring Boot 4 features utilized properly
