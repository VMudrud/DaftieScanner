...
2. Read `.claude/PLAN.md` — understand current project context and active milestone
3. Load relevant skills by reading from `.claude/skills/`:
   - Always load: `code-quality/SKILL.md`
   - For logging/observability: `logging-patterns/SKILL.md`
4. Implement production-ready containerization following CLAUDE.md core principles: simplicity, minimal code, no laziness
